...
public final class StdDrawView extends JComponent implements DrawView {
     ...
     *
     * @param aModel the model that this view will visualize.
     */
...
//				}
     ...
     *
     * @param p    the point to constrain
     * @param mode indicates from which method this method is called (mousePressed, mouseDragged
     ...
     *
     * @param selRectangle new selection rectangle.
     */
    @Override
